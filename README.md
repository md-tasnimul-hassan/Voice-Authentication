...
* **Digital Signal Processing:** Automated DC offset removal, pre-emphasis filtering, amplitude normalization, and dynamic silence truncation.
...
4. **Verification (Testing):** The MFCCs of a login attempt are compared against saved Codebooks using Euclidean Distance (`pdist2`). If the average minimum distortion falls below a tuned threshold (carefully specified while testing phase), access is granted.
...
1. Clone the repository:
   ```bash
   git clone https://github.com/md-tasnimul-hassan/Voice-Authentication.git
